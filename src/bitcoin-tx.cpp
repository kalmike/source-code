...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " quattro-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  quattro-tx [options] <hex-tx> [commands]  Update hex-encoded quattro transaction\n" +
            "or:     quattro-tx [options] -create [commands]   Create hex-encoded quattro transaction\n" +
            "\n";
