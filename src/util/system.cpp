...
const char * const BITCOIN_CONF_FILENAME = "quattro.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Quattro";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Quattro";
#else
    // Unix
    return pathRet / ".quattro";
#endif
#endif
}
