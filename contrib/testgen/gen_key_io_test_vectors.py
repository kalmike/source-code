...
bech32_templates = [
  ...
  ('qnx',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('qnx',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('qnx',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tqnx',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tqnx',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tqnx',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rqnx',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rqnx',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rqnx', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tqnx',  17, 32, False, False, False),
  ('rqnx',  3,  1, False, False, False),
  ('qnx',   15, 41, False, False, False),
  ('tqnx',  0, 16, False, False, False),
  ('rqnx',  0, 32, True,  False, False),
  ('qnx',   0, 16, True,  False, False),
  ('tqnx',  0, 32, False, True,  False),
  ('rqnx',  0, 20, False, False, True)
]
