# Support for Output Descriptors in Quattro Core

Since Quattro Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `qnx1...` for mainnet or `tqnx1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Quattro's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Quattro Core wallets, a convenience function `combo` is
