...
"""Verify that starting quattro with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start quattro with -h for help text")
        ...
        self.log.info("Start quattro with -version for version information")
        ...
        self.log.info("Start quattrod with -fakearg to make sure it does not start")
